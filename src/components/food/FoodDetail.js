                            ...
                            <tbody>
                                <tr>
                                    <td className={'text-center'} width={'30%'} rowSpan={'8'}>
                                        <img src={foodDetail && 'https://www.menupan.com' + foodDetail.poster} alt="" style={{ width: "320px", height: "320px" }} />
                                    </td>
                                    <td colSpan={'2'}>
                                        <h3>{foodDetail && foodDetail.name}&nbsp;<span style={{color: "orange"}}>{ foodDetail && foodDetail.score}</span></h3>
                                    </td>
                                </tr>
                                <tr>
