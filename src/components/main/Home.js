                                ...
                                <div className="col-12">
                                    <div className="single-post wow fadeInUp" data-wow-delay=".2s">
                                        ...
                                        <div className="post-content">
                                            <div className="post-meta d-flex">
                                                ...
                                                <div className="post-comment-share-area d-flex">
                                                    <div className="post-favourite">
                                                        <a href="#"><i className="fa fa-heart-o" aria-hidden="true"></i>{mainData?.mp?.likecount}</a>
                                                    </div>
                                                    <div className="post-comments">
                                                        <a href="#"><i className="fa fa-comment-o" aria-hidden="true"></i>{mainData?.mp?.hit}</a>
                                                    </div>
                                            ...
                                            <a href="#"><h2 className="post-headline">{mainData?.mp?.name}</h2></a>
                                            <p>{mainData?.mp?.theme}</p>
                                            <a href="#" className="read-more">Continue Reading..</a>
                                        </div>
                                    </div>
                                </div>

                                {mainData?.mList?.map((food, idx) => (
                                    <div className="col-12 col-md-6" key={idx}>
                                        <div className="single-post wow fadeInUp" data-wow-delay=".4s">
                                            ...
                                            <div className="post-content">
                                                ...
                                                <a href="#"><h4 className="post-headline">{food.name}</h4></a>
                                            </div>
                                        </div>
                                    </div>
                                ))}

                                {mainData?.lList?.map((food, idx) => (
                                    <div className="col-12" key={idx}>
                                        <div className="list-blog single-post d-sm-flex wow fadeInUpBig" data-wow-delay=".1s">
                                            <div className="post-thumb">
                                                <img src={"http://www.menupan.com" + food.poster} alt="" />
                                            </div>
                                            <div className="post-content">
                                ...
                                <div className="col-12 col-sm-8 col-md-6 col-lg-4">
                                    <div className="blog-sidebar mt-5 mt-lg-0">
                                        ...
                                        <div className="single-widget-area newsletter-widget">
                                            ...
                                            <p>Subscribe our newsletter for updates and discounts.</p>
